...
v=turtle.Turtle()
v.hideturtle(),v.speed(4)
#pipe start point
v.up(),v.goto(-260,600),v.down(),v.pensize(5)
#pipe and pipe color
for i in range(2):
	v.begin_fill(),v.fd(40),v.rt(90),v.fd(1000),v.rt(90),v.fillcolor("brown"),v.end_fill()
#circle in at the too of pipe
v.begin_fill(),v.fd(15),v.circle(20),v.fillcolor("gold"),v.end_fill(),v.fd(15)
